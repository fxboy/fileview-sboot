...
public class DocViewImpl extends AbsView {
    ...
    public FileInputStream open(IFile file) throws IOException {
       return new FileInputStream(ConvertUtils.wordToPdf(file.getFile()));
    }

    @Override
    public String view(IFile file) throws IOException {
        return ViewUtils.cvHtml(ConvertUtils.pdfToImageBase64(ConvertUtils.wordToPdf(file.getFile())));
    }
